# Generated by Django 5.1.7 on 2025-04-13 09:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(blank=True, choices=[('A', 'Section A'), ('B', 'Section B'), ('C', 'Section C'), ('D', 'Section D')], max_length=10, null=True)),
                ('branch', models.CharField(max_length=100)),
                ('en_Number', models.CharField(blank=True, max_length=100, null=True, unique=True)),
